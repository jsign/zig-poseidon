// Autogenerated: './word_by_word_montgomery' --lang Zig --internal-static --public-function-case camelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case UpperCamelCase --no-prefix-fiat --package-name babyJubJubScalar '' 64 21888242871839275222246405745257275088548364400416034343698204186575808495617 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
// curve description (via package name): babyJubJubScalar
...
pub fn sub(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    addcarryxU64(&x10, &x11, 0x0, x1, (x9 & 0x43e1f593f0000001));
    var x12: u64 = undefined;
    var x13: u1 = undefined;
    addcarryxU64(&x12, &x13, x11, x3, (x9 & 0x2833e84879b97091));
    var x14: u64 = undefined;
    var x15: u1 = undefined;
    addcarryxU64(&x14, &x15, x13, x5, (x9 & 0xb85045b68181585d));
    var x16: u64 = undefined;
    var x17: u1 = undefined;
    addcarryxU64(&x16, &x17, x15, x7, (x9 & 0x30644e72e131a029));
    out1[0] = x10;
    out1[1] = x12;
    out1[2] = x14;
    out1[3] = x16;
...
pub fn msat(out1: *[5]u64) void {
    ...
    out1[0] = 0x43e1f593f0000001;
    out1[1] = 0x2833e84879b97091;
    out1[2] = 0xb85045b68181585d;
    out1[3] = 0x30644e72e131a029;
    out1[4] = cast(u64, 0x0);
}
...
pub fn divstep(out1: *u64, out2: *[5]u64, out3: *[5]u64, out4: *[4]u64, out5: *[4]u64, arg1: u64, arg2: [5]u64, arg3: [5]u64, arg4: [4]u64, arg5: [4]u64) void {
    ...
    var x39: u64 = undefined;
    var x40: u1 = undefined;
    subborrowxU64(&x39, &x40, 0x0, x31, 0x43e1f593f0000001);
    var x41: u64 = undefined;
    var x42: u1 = undefined;
    subborrowxU64(&x41, &x42, x40, x33, 0x2833e84879b97091);
    var x43: u64 = undefined;
    var x44: u1 = undefined;
    subborrowxU64(&x43, &x44, x42, x35, 0xb85045b68181585d);
    var x45: u64 = undefined;
    var x46: u1 = undefined;
    subborrowxU64(&x45, &x46, x44, x37, 0x30644e72e131a029);
    var x47: u64 = undefined;
    ...
    var x62: u64 = undefined;
    var x63: u1 = undefined;
    addcarryxU64(&x62, &x63, 0x0, x53, (x61 & 0x43e1f593f0000001));
    var x64: u64 = undefined;
    var x65: u1 = undefined;
    addcarryxU64(&x64, &x65, x63, x55, (x61 & 0x2833e84879b97091));
    var x66: u64 = undefined;
    var x67: u1 = undefined;
    addcarryxU64(&x66, &x67, x65, x57, (x61 & 0xb85045b68181585d));
    var x68: u64 = undefined;
    var x69: u1 = undefined;
    addcarryxU64(&x68, &x69, x67, x59, (x61 & 0x30644e72e131a029));
    var x70: u64 = undefined;
    ...
    var x102: u64 = undefined;
    var x103: u1 = undefined;
    subborrowxU64(&x102, &x103, 0x0, x94, 0x43e1f593f0000001);
    var x104: u64 = undefined;
    var x105: u1 = undefined;
    subborrowxU64(&x104, &x105, x103, x96, 0x2833e84879b97091);
    var x106: u64 = undefined;
    var x107: u1 = undefined;
    subborrowxU64(&x106, &x107, x105, x98, 0xb85045b68181585d);
    var x108: u64 = undefined;
    var x109: u1 = undefined;
    subborrowxU64(&x108, &x109, x107, x100, 0x30644e72e131a029);
    var x110: u64 = undefined;
    var x111: u1 = undefined;
...
pub fn divstepPrecomp(out1: *[4]u64) void {
    ...
    out1[0] = 0x99ddb8c9f8b62554;
    out1[1] = 0x9d24a395a4811e46;
    out1[2] = 0x241215ce0ed81b0;
    out1[3] = 0x2e6a72a316e4cfb6;
}
